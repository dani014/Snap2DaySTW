...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { post_id: @comentario.post_id, texto: @comentario.texto, usuario_id: @comentario.usuario_id }
    end
  ...
  test "should update comentario" do
    put :update, id: @comentario, comentario: { post_id: @comentario.post_id, texto: @comentario.texto, usuario_id: @comentario.usuario_id }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
